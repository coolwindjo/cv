...
||
|:------------------------|
| A lifelong builder inspired by engineering excellence, I have evolved from a curious maker into a Senior Systems Architect with 12+ years of experience delivering safety-critical automotive systems—from **Proof Of Concept (POC)** to **Start Of Production (SOP)**. Proven track record in optimizing perception pipelines and reliability engineering for **Mercedes-Benz** and **Stellantis**. I maintain technical integrity across the full **V-Model** lifecycle, from **Software Requirements Analysis (SWE.1)** through to **Qualification Testing (SWE.6)**. Driven by a lifelong "maker" spirit—transitioning from a state-level science gold prize to an **Elite Interdisciplinary Research Privilege** (Computer Science and Mechanical Engineering convergence) at **KAIST**—I bridge the gap between stochastic AI and deterministic reliability. Currently based in **Munich** with a valid **EU Blue Card**,**available immediately**. Off-duty, I manage paper-based quantitative asset portfolios, stay agile on a skateboard, or hit the nearby Alps—where my snowboarding dreams have finally transitioned from a distant vision to a local reality. <span class="print-hide"><br><br>I've recently published peer-reviewed research including <a href="#publications"><b>LiDAR Denoising Methods in Adverse Environments: A Review</b></a> published in IEEE Sensors Journal, 2025, and <a href="#publications"><b>Kalman Filter-Based Suspicious Object Tracking for Border Security and Surveillance System using Fixed Automotive Radar</b></a> for Sensor Signal Processing for Defence 2023.</span> |
...
||||
|:-------------|:------------------|:------|
| **KAIST<br>(Korea Advanced Institute of Science and Technology)**<br>(Feb. 2011 – Feb. 2013) |  _M.S. in Mechanical Engineering (Granted Elite Interdisciplinary Research Privilege for Computer Science & Mechanical Engineering convergence)_ <br>&nbsp;&nbsp;&nbsp;&nbsp;• **Focus:** HRI & Optimization algorithm at UTRC (Unmanned Tech Research Center)—the nation’s premier robotics lab supported by the Ministry of National Defense.<br>&nbsp;&nbsp;&nbsp;&nbsp;• **Thesis:** [_Model-based Optimal Hand Posture Recognition using Kinect Sensor_](<https://koasas.kaist.ac.kr/handle/10203/181739>){:target="_blank"} - Developed Particle Swarm Optimization (PSO) algorithms for Twisted String Actuator (TSA) manipulators; analyzed hardware-acceleration requirements to ensure deterministic real-time performance.<br>&nbsp;&nbsp;&nbsp;&nbsp;• **Honors:** BK21 Outstanding Globalization Award; Full BK21 Research Scholarship. | Daejeon, Korea |
| **Hanyang University**<br>(Mar. 2004 – Feb. 2011) | _B.S. in Computer Science_<br>&nbsp;&nbsp;&nbsp;&nbsp;• **Capstone Project:** _“NoteMate”_ (AR-based virtual drawing device)<br>&nbsp;&nbsp;&nbsp;&nbsp;• Awarded **Best Project** in Capstone Design Fair.<br>&nbsp;&nbsp;&nbsp;&nbsp;• **Scholarships:** Recipient of 6 scholarships, including Full Scholarships for highest distinction. | Seoul, Korea |
| **Pohang High School**<br> (Mar. 2000 – Feb. 2003) | *Natural Sciences Track* <br>    • **Activity:** Science Club Member (Focus on Applied Physics & Mechanics). | Pohang, Korea |
| **Daedo Middle School**<br>(Mar. 1997 – Feb. 2000) | *Secondary Education*<br>    • **Activity:** Boy Scouts of Korea. | Pohang, Korea |
| **Dongbu Elementary School**<br>(Mar. 1991 – Feb. 1997) | *Primary Education* <br>    • **Award:** Gold Prize (1st Place), Gyeongsangbuk-do Science Kit Competition (1996) Awarded by South Korea’s largest province. | Pohang, Korea |
...
|||
|:-------------|:------------------|
| **Safety-Critical Architecture:** | Advanced expertise in **ISO 26262 (Functional Safety)** with a focus on **ASIL-B** and **ASPICE CL3**. |
| **Embedded Optimization:** | Proficiency in **Zero-copy Direct Memory Access (DMA)**, **Double Buffering** and maximizing **heterogeneous SoC** (System on Chip) throughput while meeting stringent NCAP (New Car Assessment Programme) real-time requirements. |
| **Deterministic SW Foundations:** | Senior proficiency in **C++ (11/14/17)** for real-time embedded systems and **ROS 2 (Robot Operating System)**; architecting isolated environments via **Docker** and **CI/CD (Continuous Integration / Continuous Deployment)**. |
| **Physical AI Integration:** <br>_(Ongoing Development)_| Bridging stochastic AI with deterministic C++ environments; focusing on **VLA (Vision-Language-Action)** model integration and **Inference Optimization** (e.g., **Quantization via llama.cpp**). |
| **Reliability & Simulation:** <br>_(Ongoing Development)_| Utilizing **Sim-to-Real** strategies with **NVIDIA Isaac Sim** to ensure high-fidelity deployment and safety-validation in physical robotic systems. |
...
| **LG Electronics**<br>(Jan. 2021 – Feb. 2022) | **Senior Automotive Software Engineer, In-cabin Vision Systems**<br>*Focus: AI Deployment & Infrastructure Automation*<br>&nbsp;&nbsp;&nbsp;&nbsp;• Engineered GPU-accelerated **CI/CD (Continuous Integration / Continuous Deployment)** via **DinD (Docker-in-Docker)**, reducing research-to-target lead time by 60%.<br>&nbsp;&nbsp;&nbsp;&nbsp;• Designed an automated **MLOps (Machine Learning Operations)** quantization pipeline to ensure deterministic AI performance on constrained automotive SoCs.<br>**Skills**: Jenkins, Docker, NVIDIA-Docker, MLOps, Model Quantization, Shell Scripting <br>**Customer**: HKMC (Hyundai Kia Motor Company) | Seoul, Korea |
| **LG Electronics**<br>(Jan. 2016 – Dec. 2020) | **Senior Systems Architect, Multi-Purpose Camera (MPC) 5.5 Vision System Project**<br>*Focus: AI-Enhanced Perception Pipeline*<br>&nbsp;&nbsp;&nbsp;&nbsp;• Engineered **ASIL-B** edge-case perception pipelines by **optimizing CNN inference** efficiency on **Renesas V3H**; enforced **deterministic OEM KPIs** over **stochastic AI** outputs to meet the **ASPICE CL3** mass-production standards.<br>&nbsp;&nbsp;&nbsp;&nbsp;• Refactored legacy monoliths via **DSM (Design Structure Matrix)**, reducing compilation time by 30% to engineer a **decoupled, high-bandwidth data backbone** for integrating modern VLA (Vision-Language-Action) models into **safety-critical frameworks**.<br>&nbsp;&nbsp;&nbsp;&nbsp;• Architected a **Jenkins**-based automated KPI (Key Performance Indicator) evaluation framework with **C++ TDD (gtest/gmock)** to secure V-Model integrity; this **deterministic validation logic** provides the foundational architecture for modern LLM-eval **guardrails** and Agentic MLOps pipelines.<br>**Customer**: Mercedes-Benz<br>**Awards**: [LG Wins AutoSens 2020 Vision Award](<https://www.lg.com/global/newsroom/news/vehicle-component-solutions/lg-wins-autosens-2020-vision-award-for-collaboration-with-mercedes-benz/>){:target="_blank"}<span class="print-hide"><br>**Article links**: [LG ADAS Vision System - Driving Solutions](<https://www.lg.com/global/mobility/adas-vision-system/driving-solutions>){:target="_blank"} / [LG ADAS in new Mercedes-Benz C-Class](<https://www.lg.com/global/newsroom/news/vehicle-component-solutions/lg-adas-camera-module-boosts-driver-and-passenger-safety-in-new-mercedes-benz-c-class/>){:target="_blank"}</span> <br>**Skills**: C++, Renesas V3H, Zero-copy DMA, Enterprise Architect, Lattix DSM, Jenkins, TDD, ISO 26262, ASPICE CL3 | Seoul, Korea |
| **LG Electronics**<br>(Jan. 2014 – Jan. 2016) | **Application Software Developer**, ADAS Research & PoC:<br>&nbsp;&nbsp;&nbsp;&nbsp;• Implemented high-performance signal visualization tools using **ADTF and C++** for OEM demonstrations.<br>&nbsp;&nbsp;&nbsp;&nbsp;• Developed CAN routing modules and initiated early-phase ISO 26262 functional safety foundations.| Incheon, Korea |
...
||||
|:-------------|:------------------|:------|
| [IEEE Sensors Journal](<https://ieee-sensors.org/ieee-sensors-journal/>){:target="_blank"} <br>(2025) | [LiDAR Denoising Methods in Adverse Environments: A Review](<https://ieeexplore.ieee.org/abstract/document/10839256>){:target="_blank"} <br>&nbsp;&nbsp;&nbsp;&nbsp;• Analyzed ML-based noise reduction techniques — bridging domain expertise with modern deep learning approaches |
...
||||
|:-------------|:------------------|:------|
| **KOREAN** - **Native** | **GERMAN** - **B1 in progress** |**ENGLISH** - **Fluent** |
