...
||
|:------------------------|
| My journey as a "maker" began with a Gold Prize at a state-level science competition, fueling a path that led to an Elite Interdisciplinary Research Privilege at the Korea Advanced Institute of Science and Technology (KAIST). Now a Senior Systems Architect, I specialize in ensuring deterministic reliability for safety-critical Physical AI. Currently based in Munich with a valid EU Blue Card, I am available for immediate contribution. Off-duty, I stay agile on a skateboard or in the nearby Alps—where my snowboarding dreams have finally transitioned from a vision to a local reality.<span class="print-hide"><br><br>I've recently published peer-reviewed research including <a href="#publications"><b>LiDAR Denoising Methods in Adverse Environments: A Review</b></a> published in IEEE Sensors Journal, 2025, and <a href="#publications"><b>Kalman Filter-Based Suspicious Object Tracking for Border Security and Surveillance System using Fixed Automotive Radar</b></a> for Sensor Signal Processing for Defence 2023.</span> |
...
| **Hanyang University**<br>(Mar. 2004 – Feb. 2011) | _B.S. in Major of Computer (Computer Science)_<br>&nbsp;&nbsp;&nbsp;&nbsp;• **Capstone Project:** _“NoteMate”_ (AR-based virtual drawing device)<br>&nbsp;&nbsp;&nbsp;&nbsp;• Awarded **Best Project** in Capstone Design Fair.<br>&nbsp;&nbsp;&nbsp;&nbsp;• **Scholarships:** Recipient of 6 scholarships, including Full Scholarships for highest distinction. | Seoul, Korea |
...
| **Embedded Optimization:** | Expertise in **Zero-copy Direct Memory Access (DMA)**, **Double Buffering**, and maximize **heterogeneous SoCs** (System on Chips) throughput while meeting stringent NCAP (New Car Assessment Programme) real-time requirements. |
...
| **Physical AI Integration:** <br>(Strategic Roadmap 2026)| Bridging stochastic AI with deterministic C++ environments; focusing on **VLA (Vision-Language-Action)** model integration and **Inference Optimization** (e.g., **Quantization via llama.cpp**). |
| **Reliability & Simulation:** <br>(Strategic Roadmap 2026)| Utilizing **Sim-to-Real** strategies with **NVIDIA Isaac Sim** to ensure high-fidelity deployment and safety-validation in physical robotic systems. |
