...
| **LG Electronics**<br>(Jan. 2016 – Dec. 2020) | **Senior Systems Architect, Multi-Purpose Camera (MPC) 5.5 Vision System**<br>*Focus: ASIL-B & ASPICE CL3 Mass-Production Architecture*<br>&nbsp;&nbsp;&nbsp;&nbsp;• **Architectural Authority:** Orchestrated end-to-end perception pipelines on **Renesas R-Car V3H**, achieving **ASIL-B** and **ASPICE CL3** for global mass-production (SOP).<br>&nbsp;&nbsp;&nbsp;&nbsp;• **Structural Integrity:** Refactored legacy "God Classes" using **DSM (Design Structure Matrix)** to eliminate cyclic dependencies, reducing compilation time by 30% and ensuring deterministic execution for safety-critical logic.<br>&nbsp;&nbsp;&nbsp;&nbsp;• **High-Performance Deployment:** Optimized real-time data pipelines using **Zero-copy DMA** and Double Buffering, bridging heavy **CNN (Convolutional Neural Network)** vision tasks with deep embedded hardware constraints.<br>&nbsp;&nbsp;&nbsp;&nbsp;• **Verification Leadership:** Established a **Jenkins-based** automated **KPI (Key Performance Indicator) evaluation system** and **TDD (Test-Driven Development)** culture using **gtest/gmock**, ensuring zero-regression during the V-Model lifecycle. <br>**Customer**: Mercedes-Benz<br>**Awards**: [LG Wins AutoSens 2020 Vision Award](<https://www.lg.com/global/newsroom/news/vehicle-component-solutions/lg-wins-autosens-2020-vision-award-for-collaboration-with-mercedes-benz/>){:target="_blank"}<span class="print-hide"><br>**Article links**: [LG ADAS Vision System - Driving Solutions](<https://www.lg.com/global/mobility/adas-vision-system/driving-solutions>){:target="_blank"} / [LG ADAS in new Mercedes-Benz C-Class](<https://www.lg.com/global/newsroom/news/vehicle-component-solutions/lg-adas-camera-module-boosts-driver-and-passenger-safety-in-new-mercedes-benz-c-class/>){:target="_blank"}</span> <br>**Skills**: C++, Renesas V3H, Zero-copy DMA, Enterprise Architect, Lattix DSM, Jenkins, TDD, ISO 26262, ASPICE CL3 | Seoul, Korea |
| **LG Electronics**<br>(Jan. 2014 – Feb. 2016) | **Application Software Developer**, ADAS Research & PoC:<br>&nbsp;&nbsp;&nbsp;&nbsp;• Implemented high-performance signal visualization tools using **ADTF and C++** for OEM demonstrations.<br>&nbsp;&nbsp;&nbsp;&nbsp;• Developed CAN routing modules and initiated early-phase ISO 26262 functional safety foundations.| Incheon, Korea |
